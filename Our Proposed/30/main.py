...
NUM_NODES = 30
NUM_CLUSTERS = 12
SEND_RANGE = 20  # meters
MAX_LONGITUDE = 100.0  # meters
MAX_LATITUDE = 100.0  # meters

# Energy parameters (adjusted for more realistic WSN behavior)
NODE_INITIAL_ENERGY = 150  # Joules
...
class DatasetLoader:
    ...
    def get_sensor_reading(self, node_id, time_index, column='temperature_mean'):
        """Get a sensor reading for a specific node at a specific time index with enhanced data generation for 30 nodes"""
        ...
        if node_id not in self.node_data or self.node_data[node_id] is None:
            # Enhanced data generation for 30-node network
