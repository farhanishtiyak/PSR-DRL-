#!/usr/bin/env python3
"""
Script to compare PSR-DRL vs RLBEEP vs EER-RL (10 Nodes)
"""
...
def plot_comparison(dql_csv, traditional_csv):
    ...
    plt.title('PSR-DRL - 10 Nodes', fontweight='bold')
    ...
    plt.xlabel('Epoch', fontsize=14)
    plt.ylabel('First Node Death Time (s)', fontsize=14)
    plt.title('RLBEEP - 10 Nodes', fontweight='bold')
    plt.grid(True, alpha=0.3)
    plt.legend(loc='upper right')
    ...
    comparison_file = 'results/comparison_pswr_drl_vs_rlbeep_10nodes.png'
    ...
    overlay_file = 'results/overlay_comparison_10nodes.png'
    ...
    print("\n" + "="*60)
    print("PERFORMANCE SUMMARY - 10 Nodes")
    print("="*60)
    print(f"PSR-DRL:")
...
def plot_comparison_with_eerrl(dql_csv, traditional_csv, eerrl_csv):
    ...
    overlay_file = 'results/overlay_comparison_all_methods_10nodes.png'
    overlay_file_pdf = 'results/overlay_comparison_all_methods_10nodes.pdf'
    plt.savefig(overlay_file, dpi=300, bbox_inches='tight')
