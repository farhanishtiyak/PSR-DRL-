...
results_file = 'first_node_death_epochs.csv';  % Output file name
...
for epoch_num = 1:total_epochs
    ...
    % Show progress
    fprintf('Epoch %d/%d: First node death at round %d\n', epoch_num, total_epochs, first_node_death_round);
...
title('Distribution of First Node Death Rounds');
xlabel('Round Number');
ylabel('Frequency');
saveas(gcf, 'first_node_death_histogram.png');
