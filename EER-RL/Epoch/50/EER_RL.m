...
send_energy = 0.4; % units in Joules (fixed value for sending data)
receive_energy = 0.25; % units in Joules (fixed value for receiving data)
active_energy = 0.12; % units in Joules (energy consumed per round for being active)
...
for i=1:n
    ...
    NET(i).E = 200 + (rand(1,1)*40 - 15); % Initial energy: random between 130 and 170
    NET(i).Eo = NET(i).E;
