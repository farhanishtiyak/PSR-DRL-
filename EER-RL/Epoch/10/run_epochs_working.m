...
results_file = 'first_node_death_epochs_10nodes.csv';  % Output file name (for 10 nodes)
...
for epoch_num = 1:total_epochs
    ...
    % Show progress
    fprintf('Epoch %d/%d (10 nodes): First node death at round %d\n', epoch_num, total_epochs, first_node_death_round);
...
title('Distribution of First Node Death Rounds (10 Nodes)');
xlabel('Round Number');
ylabel('Frequency');
saveas(gcf, 'first_node_death_histogram_10nodes.png');
