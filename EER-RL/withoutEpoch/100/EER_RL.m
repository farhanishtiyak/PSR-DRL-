...
send_energy = 0.5; % units in Joules (fixed value for sending data)
receive_energy = 0.3; % units in Joules (fixed value for receiving data)
active_energy = 0.15; % units in Joules (energy consumed per round for being active)
...
for i=1:n
    ...
    NET(i).E = 200 + (rand(1,1)*40 - 20); % Initial energy: random between 180 and 220
    NET(i).Eo = NET(i).E;
